...
import PointSeparator from '../../Components/common/PointSeparator'
import ReplyCount from '../../Components/common/TopicList/ReplyCount'
...
class UserTopicPage extends Component {
  ...
  _loadTopicList () {
    ...
    V2exApi.getPage(`/member/${username}/topics`)
      .then($ => {
