...
class V2exNetworking {
  static get (uri) {
    return V2exNetworking.request('GET', uri)
  }

  static getJSON (uri) {
    return V2exNetworking.request('GET', uri, null, null, true)
  }
